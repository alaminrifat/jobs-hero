                ...
                <div className="bg-indigo-50 w-96 p-12 rounded-lg">
                    <div>
                        ...
                        <p className="mt-2 flex gap-2">
                            ...
                            Salary: <span className="text-gray-400">{job.salary}</span>
                        </p>
                        <p className="mt-2 flex gap-2">
                            <svg
                                xmlns="http://www.w3.org/2000/svg"
                            ...
                            Job Title: <span className="text-gray-400">{job.job_Title}</span>
                        </p>
                        <h1 className="font-semibold text-md my-2">
                            Contact Information
                        </h1>
                        ...
                        <p className="mt-2 flex gap-2">
                            ...
                            Phone: <span className="text-gray-400">{job.phone}</span>
                        </p>
                        <p className="mt-2 flex gap-2">
                            <svg
                                xmlns="http://www.w3.org/2000/svg"
                            ...
                            Email: <span className="text-gray-400">{job.email}</span>
                        </p>
                        <p className="mt-2 flex gap-2">
                            <svg
                                xmlns="http://www.w3.org/2000/svg"
                            ...
                            Address: <span className="text-gray-400">{job.address}</span>
                        </p>
                    </div>
                    <div>
                        <button className="btn-primary text-center mt-4 w-full">Apply Now</button>
                    </div>
                </div>
            </div>
        </div>
